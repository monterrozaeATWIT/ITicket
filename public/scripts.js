...
// Fetch and display tickets (for IT dashboard)
...
// View individual ticket details (for IT dashboard)
async function viewTicket(id) {
    ...
    ticketDetails.innerHTML = `
        ...
        <p><strong>Submitted At:</strong> ${new Date(ticket.createdAt).toLocaleString()}</td>
